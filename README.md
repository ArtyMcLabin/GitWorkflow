...
2. Add these rules to your Cursor Settings -> Rules -> User Rules:
   ...
   ```
   The below one is optional, but highly recommended. do keep in mind tho that it standardize your issue creation through Cursor across all your projects:
   ```
   b) Issue Creation 
